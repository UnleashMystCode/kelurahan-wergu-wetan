    ...
    <div className="min-h-screen bg-slate-50 pb-20">
      ...
      <div className="relative flex min-h-[60vh] w-full flex-col justify-center bg-slate-900 pb-12 pt-[140px] md:pt-[160px]">
        <div className="relative z-10 container mx-auto max-w-4xl px-4">
          {/* Back Button */}
          <div className="mb-8 h-10 w-48 rounded-full bg-slate-800 animate-pulse" />
          ...
          {/* Title */}
          <div className="mb-4 h-10 w-full max-w-2xl rounded-xl bg-slate-800 animate-pulse md:h-14 lg:h-16" />
          <div className="mb-8 h-10 w-3/4 rounded-xl bg-slate-800 animate-pulse md:h-14 lg:h-16" />
          
          {/* Author */}
          <div className="flex items-center gap-4 mt-8">
            <div className="h-12 w-12 rounded-full bg-slate-800 animate-pulse" />
            <div>
              <div className="mb-2 h-4 w-32 rounded-full bg-slate-800 animate-pulse" />
              <div className="h-3 w-48 rounded-full bg-slate-800/50 animate-pulse" />
            </div>
          </div>
        </div>
      </div>
