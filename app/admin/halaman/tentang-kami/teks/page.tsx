...
const KATEGORI_LIST = [
  {
    ...
    icon: Target,
    placeholder:
      "Tulis visi dan misi kelurahan di sini. Bisa menggunakan HTML sederhana seperti <ul><li>...",
  },
  {
    id: "tugas_fungsi",
    label: "Tugas & Fungsi",
    icon: Briefcase,
    placeholder: "Tulis uraian tugas dan fungsi perangkat kelurahan di sini...",
  },
  {
    id: "sejarah",
    label: "Sejarah Desa",
    icon: History,
    placeholder: "Tulis sejarah singkat Desa/Kelurahan Wergu Wetan di sini...",
  },
];
...
export default async function AdminProfilTeksPage() {
  ...
  const getKonten = (kategori: string) => kontenList.find((k) => k.kategori === kategori);
    ...
    <div className="space-y-8 pb-20">
      <div>
        ...
        <p className="mt-1 text-sm text-slate-500">
          Edit teks panjang untuk Visi Misi, Tugas Fungsi, dan Sejarah Desa yang tampil di halaman
          Tentang Kami.
        </p>
      </div>
      ...
      <div className="space-y-6">
        {KATEGORI_LIST.map(({ id, label, icon: Icon, placeholder }) => {
          ...
          return (
            ...
            >
              {/* Card Header */}
              <div className="flex items-center gap-3 border-b border-slate-100 bg-slate-50/50 px-8 py-5">
                ...
                <div>
                  ...
                  {existing?.updatedAt && (
                    <p className="text-[10px] text-slate-400">
                      Terakhir diperbarui:{" "}
                      {existing.updatedAt.toLocaleDateString("id-ID", {
                        day: "numeric",
                        month: "long",
                        year: "numeric",
                        hour: "2-digit",
              ...
              {/* Form */}
              <form action={simpanProfilKonten} className="space-y-5 p-8">
                ...
                <div className="space-y-1.5">
                  <label className="flex items-center gap-2 text-[10px] font-black tracking-widest text-slate-400 uppercase">
                    ...
                    <span className="rounded-full bg-amber-100 px-2 py-0.5 text-[9px] font-black text-amber-600">
                      HTML OK
                    </span>
                  </label>
                  <textarea
                    ...
                    required
                    className="w-full resize-y rounded-xl border-2 border-transparent bg-slate-50 p-4 font-mono text-sm text-slate-800 transition outline-none focus:border-blue-500/30"
