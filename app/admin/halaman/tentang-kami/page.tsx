...
export default async function AdminProfilPage() {
  ...
  return (
    <div className="space-y-8 pb-20">
      ...
      <section>
        <h2 className="text-lg font-bold text-slate-700 mb-4 border-l-4 border-blue-600 pl-3">A. Hero Banner Tentang Kami</h2>
      ...
      <div className="p-10 text-center border-2 border-dashed border-slate-300 rounded-2xl text-slate-400">
